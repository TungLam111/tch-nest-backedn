...
export class LocationService {
    ...
    async getLocationsByUser(user: User): Promise<ApiResponse> {
    ...
    async updateLocation(user: User, newLocation: UpdateLocationDto): Promise<ApiResponse> {
        const response = new ResponseData()
        try {
    ...
    async addLocation(user: User, newLocation: CreateLocationDto): Promise<ApiResponse> {
        const response = new ResponseData()
        try {
    ...
    async getLocation(user: User, id: string): Promise<ApiResponse> {
        const response = new ResponseData()
        try {
    ...
    async deleteLocation(user: User, id: string): Promise<ApiResponse> {
        const response = new ResponseData()
        try {
            let location = await this.locationRepository.findOne({
                where: {
